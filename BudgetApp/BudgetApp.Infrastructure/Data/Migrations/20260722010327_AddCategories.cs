    ...
    public partial class AddCategories : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Categories_HouseholdId_Type_NormalizedName",
                table: "Categories",
                columns: new[] { "HouseholdId", "Type", "NormalizedName" },
                unique: true,
                filter: "[ParentCategoryId] IS NULL");

            migrationBuilder.CreateIndex(
                name: "IX_Categories_ParentCategoryId_NormalizedName",
                table: "Categories",
                columns: new[] { "ParentCategoryId", "NormalizedName" },
                unique: true,
